...
class SystemUser extends TRecord
{
    ...
    {
        return parent::loadAggregate(SystemGroup::class, SystemUserGroup::class, 'system_user_id', 'system_group_id', $this->id);
    }
    ...
    {
        return parent::loadAggregate(SystemUnit::class, SystemUserUnit::class, 'system_user_id', 'system_unit_id', $this->id);
    }
    ...
    {
        return parent::loadAggregate(SystemProgram::class, SystemUserProgram::class, 'system_user_id', 'system_program_id', $this->id);
    }
